...
// findWithSource resolves lcaseKey through the precedence chain
// (override > flag > env > config > kvstore > default > flag default)
// and reports which layer produced the value. It is the single source of
// truth for both value resolution (find) and source reporting (GetSource).
...
// It is shared by the changed-flag and flag-default branches of
// findWithSource so the two paths cannot drift apart.
